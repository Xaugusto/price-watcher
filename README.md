...
- [🖼️ Protótipo no Figma](#) - Telas interativas ([adicione seu link aqui]https://www.figma.com/design/gDR2vWH7VWbVcbxkZj9I7S/PriceWatcher?node-id=0-1&t=b1BywPwWQzpRqaQO-1).
...
- **Frontend:**
  - HTML5
  - CSS3 (ou Framework como MaterializeCSS / Bootstrap)
  - JavaScript
...
- [ ] ID 02 - Implementar layout com framework CSS
- [ ] ID 03 - Utilizar Flexbox ou Grid
- [ ] ID 04 - Utilizar componentes prontos (cards, modais, botões)
...
- [ ] ID 17 - Requisições para API Fake
- [ ] ID 18 - Exibição dinâmica de dados
- [ ] ID 19 - Integração com APIs externas (futuro)
